...
public class PowerVmAllocationPolicyMigrationInterQuartileRange extends
	...
	protected boolean isHostOverUtilized(PowerHost host) {
		Log.printLine("PowerVmAllocationPolicyMigrationInterQuartileRange.isHostOverUtilized");
	...
	protected double getHostUtilizationIqr(PowerHostUtilizationHistory host) throws IllegalArgumentException {
		Log.printLine("PowerVmAllocationPolicyMigrationInterQuartileRange.getHostUtilizationIqr");
		...
		if (zeros >= 12) { // 12 has been suggested as a safe value
			return MathUtil.iqr(dataclone);
		}
